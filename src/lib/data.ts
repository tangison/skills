...
export const SKILL_CATEGORIES: SkillCategory[] = [
  ...
  { id: 'cat-2', slug: 'web-development', name: 'Web Development', description: 'Production-grade frontend and backend development skills', icon: 'Code', skillCount: 204, sortOrder: 2 },
  { id: 'cat-3', slug: 'creative-design', name: 'Creative Design', description: 'Visual design, UI/UX, and creative asset generation', icon: 'Palette', skillCount: 34, sortOrder: 3 },
  { id: 'cat-4', slug: 'copywriting', name: 'Copywriting', description: 'Natural, believable brand copy that converts', icon: 'PenLine', skillCount: 45, sortOrder: 4 },
  { id: 'cat-5', slug: 'document-design', name: 'Document Design', description: 'Professional document creation — PDFs, Word, presentations', icon: 'FileText', skillCount: 27, sortOrder: 5 },
  { id: 'cat-6', slug: 'prompt-engineering', name: 'Prompt Engineering', description: 'Advanced prompt design and constraint enforcement', icon: 'Terminal', skillCount: 112, sortOrder: 6 },
  { id: 'cat-7', slug: 'image-generation', name: 'Image Generation', description: 'AI-powered image creation and brand kit generation', icon: 'Image', skillCount: 34, sortOrder: 7 },
  { id: 'cat-8', slug: 'flyer-design', name: 'Flyer Design', description: 'Professional flyer and poster design — print-safe, export-ready', icon: 'Layout', skillCount: 19, sortOrder: 8 },
  { id: 'cat-9', slug: 'social-media', name: 'Social Media', description: 'Social content creation, scheduling, and launch strategy', icon: 'Share2', skillCount: 56, sortOrder: 9 },
  { id: 'cat-10', slug: 'research', name: 'Research', description: 'Deep research, citation tracking, and source verification', icon: 'BookOpen', skillCount: 38, sortOrder: 10 },
  { id: 'cat-11', slug: 'automation', name: 'Automation', description: 'Workflow automation and CI/CD pipeline skills', icon: 'Cpu', skillCount: 89, sortOrder: 11 },
  { id: 'cat-12', slug: 'seo', name: 'SEO', description: 'Technical SEO auditing, structured data, and optimization', icon: 'Search', skillCount: 22, sortOrder: 12 },
  { id: 'cat-13', slug: 'brand-systems', name: 'Brand Systems', description: 'Brand identity systems, design tokens, and visual language', icon: 'Compass', skillCount: 21, sortOrder: 13 },
  { id: 'cat-14', slug: 'devops', name: 'DevOps', description: 'Infrastructure, deployment, and operational skills', icon: 'Cloud', skillCount: 41, sortOrder: 14 },
  { id: 'cat-15', slug: 'ai-infrastructure', name: 'AI Infrastructure', description: 'AI agent skills, model integration, and intelligent systems', icon: 'Server', skillCount: 67, sortOrder: 15 },
  { id: 'cat-16', slug: 'deployment', name: 'Deployment', description: 'Hosting, CDN, and production deployment strategies', icon: 'Rocket', skillCount: 41, sortOrder: 16 },
  { id: 'cat-17', slug: 'nextjs', name: 'Next.js', description: 'Next.js framework skills — App Router, RSC, and fullstack', icon: 'Box', skillCount: 156, sortOrder: 17 },
  { id: 'cat-18', slug: 'typescript', name: 'TypeScript', description: 'TypeScript type systems, generics, and strict mode patterns', icon: 'FileType', skillCount: 118, sortOrder: 18 }
];
...
export const SUPPORTED_ECOSYSTEMS: Ecosystem[] = [
  ...
  { name: 'Obra Superpower', url: 'https://skills.sh' }
];
