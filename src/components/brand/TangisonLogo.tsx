 ...
 */
function MastGlyph({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 100 120"
      fill="none"
    ...
    >
      ...
      <circle cx="50" cy="112" r="3" fill="currentColor" opacity="0.6" />
    </svg>
  );
}
  ...
  if (variant === 'mark-wordmark') {
    return (
      <div className={cn('flex items-center gap-3', className)}>
        ...
        <span className="font-display text-lg tracking-[0.12em] text-skeleton-bone uppercase select-none">
          TANGISON
        </span>
      </div>
    );
  ...
  return (
    <div className={cn('flex items-center gap-3', className)}>
      ...
      <div className="flex flex-col leading-none">
        ...
        <span className="font-editorial text-xs tracking-[0.2em] text-fog-gray uppercase select-none mt-1">
          SKILLSMITH
        </span>
      </div>
    </div>
